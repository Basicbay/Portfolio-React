  ...
  return (
    ...
    text-center md:text-left my-10'>
      ...
      <div className=" grid md:grid-cols-5 gap-10 md:gap-5 ">
        ...
        <motion.div className=' curve md:col-span-2 card bg-white place-items-center justify-center md:justify-start md:pt-10 xl:pt-5 p-5 dark:bg-neutral-900 shadow-md ' whileHover={{ scale: 1.02 }}>

          <div className="custom-shape-divider-top-1704694396 card z-0  opacity-5 dark:opacity-40">
