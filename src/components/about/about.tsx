      ...
      <div className=" grid md:grid-cols-5 gap-10 md:gap-5 ">
        ...
        <motion.div className=' md:col-span-2 card bg-white place-items-center justify-center p-5 dark:bg-neutral-900 ' whileHover={{ scale: 1.02 }}>
          ...
          <div className='flex gap-5 z-0 justify-center md:justify-start'>
            ...
            <motion.div className=' hover:text-blue-500 tooltip' data-tip="Linked" whileTap={{ scale: 1.1 }} ><a href="https://www.linkedin.com/in/nattagrit-ridtikhab-83894b2a0/" target="_blank"><i className='bx bxl-linkedin bx-md  ' ></i></a></motion.div>

            <motion.div className=' hover:text-blue-500 tooltip' data-tip="Github" whileTap={{ scale: 1.1 }} ><a href="https://github.com/Basicbay" target="_blank"><i className='bx bxl-github bx-md  '></i></a></motion.div>
