            ...
            <motion.div id='contact' className="rounded-2xl shadow-md bg-black bg-opacity-50 text-white  text-base mb-5 my-10 "
                ...
                <footer className="footer text-base p-10 justify-items-center lg:justify-items-start  ">
                    ...
                    <label className="swap">
                            <div onClick={() =>  { navigator.clipboard.writeText('0867499315')  } } className=" cursor-pointer hover:text-blue-500  hover:bg-white dark:hover:bg-neutral-950 rounded-btn p-3 w-72 text-left " ><i className='bx-fw bx bxs-phone bx-md bx-tada-hover'></i>0867499315
                            <input type="checkbox" />
                        ...
                        <motion.a href="mailto:Keepatbayy@gmail.com"  className=' tooltip' data-tip="Send Email" whileTap={{ scale: 1.2 }}>
