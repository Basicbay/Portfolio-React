      ...
      <div className=" shadow-md bg-white dark:bg-neutral-900 rounded-2xl overflow-hidden">
        ...
        <div className="card rounded-t-none grid bg-white dark:bg-neutral-900 p-10 md:px-20 gap-5 ">
          ...
          <motion.div className="font-medium grid grid-cols-4 md:grid-cols-6 text-center gap-x-10 gap-y-7  place-items-center border-b-[1px] dark:border-neutral-800 pb-7   "   >
            <div className=' col-span-4 md:col-span-2 justify-self-center md:justify-self-start ' ><p className=' text-sm lg:text-base font-bold text-neutral-400'>LANGUAGES</p></div>
          ...
          <motion.div className="font-medium grid grid-cols-4 md:grid-cols-6 text-center gap-x-10 gap-y-7 place-items-center border-b-[1px] dark:border-neutral-800 pb-7 "   >
            <div className=' col-span-4 md:col-span-2 justify-self-center md:justify-self-start ' ><p className=' text-sm lg:text-base font-bold   text-left text-neutral-400  '>RESPONSIVE DESIGN</p></div>
          ...
          <motion.div className="font-medium grid grid-cols-4 md:grid-cols-6 text-center gap-x-10 gap-y-7 place-items-center border-b-[1px] dark:border-neutral-800 pb-7  "  >
            <div className=' col-span-4 md:col-span-2 justify-self-center md:justify-self-start' ><p className=' text-sm lg:text-base font-bold   text-left text-neutral-400 '>FRAMEWORKS & LIBRARIES</p></div>
          ...
          <motion.div className="font-medium grid grid-cols-4 md:grid-cols-6 text-center gap-x-10 gap-y-7 place-items-center  dark:border-neutral-800 pb-7 "   >
            <div className=' col-span-4 md:col-span-2 justify-self-center md:justify-self-start ' ><p className=' text-sm lg:text-base font-bold   text-left text-neutral-400 '>VERSION CONTROL</p></div>
          ...
          <div className="font-medium grid grid-cols-2 md:grid-cols-8 text-center gap-x-10 gap-y-7 place-items-center pb-5 md:pb-0 hidden " >
            <div className='col-span-2 md:col-span-2 justify-self-center md:justify-self-start '><p className=' font-bold   text-left text-neutral-400   '>Build Tools :</p></div>
