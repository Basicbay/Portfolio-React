  ...
  return (
      ...
      <motion.div className="p-5 py-10 card text-white bg-black bg-opacity-50 my-10 shadow-md" whileHover={{ scale: 1.02 }}>
        ...
        <div className=" text-center self-center">
          <p className=" underline underline-offset-8 mb-10 bx-flashing">Last Updateded : 14/01/2024</p>
           ...
           {/* <p className=''><i className='bx-fw bx bx-chevron-right bx-sm ' style={{ color: '#ffffff' }}></i>Expected salary 30-35k</p> */}
            ...
            <HashLink smooth to="/#contact"
              scroll={(el) => {
                ...
                <motion.button className=' bg-white text-black w-60 font-bold rounded-2xl mt-2 p-1 text-center  hover:text-teal-500 select-none ' whileTap={{ scale: 1.1 }}>
