    ...
    return (
        ...
        text-base my-10 " whileHover={{ scale: 1.02 }}>
            ...
            <div className="  shadow-md bg-white dark:bg-neutral-900 rounded-2xl overflow-hidden">
                ...
                <div className='text-center md:text-left dark:text-white p-5 lg:p-10 grid gap-5 m-auto w-auto md:grid-cols-2 '>

                    <motion.div className="md:flex gap-8 pb-5 border-[1px] card p-5 hover:bg-neutral-100 dark:hover:bg-neutral-950 dark:border-neutral-800 dark:hover:border-neutral-950  " >
