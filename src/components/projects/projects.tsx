...
function Projects() {
  return (
    ...
    text-base my-10 " whileHover={{ scale: 1.02 }}>
      ...
      <div className='grid grid-cols-1  md:grid-cols-2 xl:grid-cols-3 gap-5 p-5 lg:p-10 pb-7 bg-black bg-opacity-25 dark:bg-opacity-50 card rounded-t-none shadow-md   '>
