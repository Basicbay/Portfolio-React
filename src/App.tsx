...
const App = () => {
  ...
  return (
    <div className={`${darkMode && 'dark'}`}>
      ...
      <label className="fixed swap swap-rotate right-0 p-5 z-30 text-neutral-600 dark:text-neutral-300   ">
      ...
      {/*<div className="cursor-default subpixel-antialiased bg-[url('img/bg3.png')] bg-cover bg-center bg-fixed  ">*/}
      <div className="cursor-default subpixel-antialiased bg-cover bg-center bg-fixed  ">

        <Navbar />

        <div className=" max-w-screen-xl m-auto pt-16 pb-10 px-5 xl:px-0 font-light   ">
          <Notice/>
          <About />
          <Skills />
          <Projects />
