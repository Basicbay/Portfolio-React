...
const App = () => {
  ...
  return (
    <div className={`${darkMode && 'dark'}`}>
      ...
      <label className="fixed swap swap-rotate right-0 p-5 pr-10 md:pr-5 z-30 text-black dark:text-white   ">
      ...
      <div className="cursor-default subpixel-antialiased bg-[url('img/bg4.jpg')] bg-cover bg-center bg-fixed  ">
