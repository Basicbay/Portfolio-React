...
const App = () => {
  ...
  return (
    <div className={`${darkMode && 'dark'}`}>
      ...
      <label className="fixed swap swap-rotate right-0 pt-14 pr-5 z-30 text-black dark:text-white ">
      ...
      <div className=' dark:bg-neutral-950 cursor-default subpixel-antialiased '>

        <Navbar />

        <div className=" max-w-screen-xl m-auto pt-28 px-5 xl:px-0 pb-28 ">
          <About />
          <Skills />
          <Projects />
          <Experience />
